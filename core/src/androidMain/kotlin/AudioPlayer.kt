...
actual object AudioPlayer {
    actual fun initializePlaybackDevice(buffer: ByteArray) {
        ...
        val sizeInFrames = buffer.size / NativeInterface.Instance.getBytesPerFrame()
        ...
        val result = NativeInterface.Instance.initializePlaybackDevice(memory, sizeInFrames)
        if (result != 0) {
